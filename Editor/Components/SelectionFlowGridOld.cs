...
{
    public class SelectionFlowGridOld : ExEditorComponent
    {
        ...
        public SelectionFlowGridOld(string title, List<string> listContent, List<string> filter, GUIStyle buttonStyle)
        {
            this._title = title;
